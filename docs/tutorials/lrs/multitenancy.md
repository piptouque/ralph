...
```bash title=".env"
RALPH_RUNSERVER_SCIM_CLIENT_OWNERSHIP__resource_types_endpoint = "https://my_scim_server/scim/v2/ResourceTypes"
RALPH_RUNSERVER_SCIM_CLIENT_OWNERSHIP__user_extension_schema  = "urn:ietf:params:scim:schemas:extension:client_access:2.0:User"
