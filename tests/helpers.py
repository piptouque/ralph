...
def configure_env_for_mock_scim_client_access(monkeypatch):
    """Configure environment variables to simulate SCIM use."""
    ...
    monkeypatch.setattr(
        "ralph.api.auth.settings.LRS_EXTEND_AUTHORITY_TO_CLIENT_ACCESS", True
    )
